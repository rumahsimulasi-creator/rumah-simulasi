...
export default function KelolaPaketPage() {
  ...
  const simpanEdit = async (id: string) => {
    const { error } = await supabase
      ...
      .update({
        ...
        urutan: Number(editData.urutan),
        butuh_pendaftaran: editData.butuh_pendaftaran,
        syarat_pendaftaran: editData.butuh_pendaftaran
          ? editData.syarat_pendaftaran
          : null,
  ...
  const hapusPaket = async (id: string) => {
    if (
      !confirm(
        'Yakin mau hapus paket ini? Soal di dalamnya juga bisa ikut kehapus.'
      )
    ) {
      return
    }
            ...
            {editId === paket.id ? (
              <div>
                ...
                <input
                  type="number"
                  style={inputStyle}
                  value={editData.waktu_menit}
                  onChange={(e) =>
                    setEditData({
                      ...editData,
                      waktu_menit: e.target.value,
                    })
                  }
                />
                ...
                >
                  Angka lebih kecil akan tampil lebih atas. Contoh: 1 = paling
                  atas.
                </p>
                ...
                >
                  <input
                    ...
                    onChange={(e) =>
                      setEditData({
                        ...editData,
                        butuh_pendaftaran: e.target.checked,
                      })
                    }
                  />
                  ...
                  <>
                    ...
                    <textarea
                      ...
                      onChange={(e) =>
                        setEditData({
                          ...editData,
                          syarat_pendaftaran: e.target.value,
                        })
                      }
                    />
                  </>
                ...
                >
                  <input
                    ...
                    onChange={(e) =>
                      setEditData({
                        ...editData,
                        tampil_di_try_out_akbar: e.target.checked,
                      })
                    }
                  />
              ...
              <div>
                ...
                {paket.butuh_pendaftaran && (
                  <p>Butuh Pendaftaran: Ya</p>
                )}

                {paket.tampil_di_try_out_akbar && (
                  <p>Try Out Akbar: Ya</p>
                )}
